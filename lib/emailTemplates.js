...
function emailHeaderUrl(theme = "nova-york") {
  ...
  if (!base) return `/email-headers/${file}`;
...
function layout({ heading, greetingName, body, ctaLabel, ctaUrl, extraLinks, theme = "nova-york" }) {
  ...
  return `
  <div style="font-family:Arial,Helvetica,sans-serif;color:#1f2937;line-height:1.62;max-width:720px;margin:0 auto;background:#f8fafc;padding:0;border:1px solid #e5e7eb;border-radius:18px;overflow:hidden;">
    <div style="background:#1f2a60;">
      <img src="${header}" alt="Resumindo Viagens" style="width:100%;max-width:720px;height:auto;display:block;border:0;" />
    </div>
