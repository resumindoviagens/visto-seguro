...
export const EMAIL_TEMPLATES = [
  ...
  { id: "passaporte_pesquisa", label: "P07 - Passaporte: pesquisa de satisfação" },
  ...
  const templates = {
    ...
    passaporte_instrucoes: {
      ...
      html: layout({
        ...
        greetingName: nomeCompleto,
        body: `
          ${paragraph(`Estou encaminhando as orientações gerais para o dia do atendimento do passaporte.`)}
          ...
          ${paragraph(`O arquivo completo de instruções segue anexo a este email.`)}
        `
      })
    },
    ...
    passaporte_pesquisa: {
      ...
      html: layout({
        ...
        greetingName: nomeCompleto,
        body: `
          ${paragraph(`Seu serviço de assessoria para emissão de passaporte foi concluído e gostaríamos muito de ouvir sua opinião.`)}
          ${paragraph(`A pesquisa é rápida e ajuda a Resumindo Viagens a melhorar continuamente o atendimento.`)}
        `,
